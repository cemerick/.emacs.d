...
#+BEGIN_SRC emacs-lisp
  ...
  (defun filename_from_title ()
    (replace-regexp-in-string " " "-" (get-headline)))
  
  (defun org-capture-blog-path ()
    (let ((name (filename_from_title)))
...
#+BEGIN_SRC emacs-lisp
  (load "~/Documents/elisp/workflow/workflow.el")
  ...
  (setq org-publish-project-alist
        '(
          ("org-perfumed-nightmare"
           ...
           :completion-function delete-blog-files
           :preparation-function (lambda () (mapcar 'expand-blog-file (select-blog-files)))
