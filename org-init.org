...
#+BEGIN_SRC emacs-lisp      
  (setq my-packages (append '(el-get smex main-line pretty-lambdada
                                     ...
                                     clojure-mode nrepl clojure-test-mode clojure-cheatsheet clojurescript-mode midje-mode nrepl-ritz kibit-mode cljsbuild-mode cljdoc slamhound
...
[[http://stackoverflow.com/questions/3376863/unable-to-type-braces-and-square-braces-in-emacs][Braces and squere braces in emacs]]
