...
#+BEGIN_SRC emacs-lisp      
  (setq my-packages (append '(el-get smex pretty-lambdada flycheck
                                     magit 
                                     projectile
                                     dash s f
                                     helm helm-project helm-descbinds                                      
                                     zenburn-theme solarized-theme nyan-mode 
                                     inf-ruby rspec-mode robe-mode
                                     emacs-w3m yaml-mode web
                                     ack-menu undo-tree elisp-slime-nav
                                     windcycle pbcopy ace-jump-mode
                                     dictionary dictionary-app
                                     html5 web-mode skewer-mode impatient-mode
                                     coffee-mode markdown-mode scss-mode mustache-mode less-css-mode
                                     clojure-mode clojure-test-mode clojure-cheatsheet clojurescript-mode midje-mode kibit-mode cljsbuild-mode cljdoc slamhound refheap 
                                     nrepl nrepl-eval-sexp-fu
                                     rainbow-mode rainbow-delimiters htmlize paredit
                                     epresent org-html5presentation org-s5
